...
public class GeneratorRecipes extends BaseRecipeProvider {
    ...
    public GeneratorRecipes(DataGenerator generator) {
        super(generator, ForceFieldGenerator.MOD_ID);
    }

    @Override
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        UpgradeRecipeBuilder.smithing(Ingredient.of(Tags.Items.INGOTS_NETHERITE), Ingredient.of(Tags.Items.NETHER_STARS), STAR_INFUSED_NETHERITE_INGOT.get())
        ...
        ShapedRecipeBuilder.shaped(FORCE_FIELD_GENERATOR_PLATE.get())
        ...
        ShapedRecipeBuilder.shaped(FORCE_FIELD_GENERATOR_CORE.get())
        ...
        ShapedRecipeBuilder.shaped(FORCE_FIELD_GENERATOR.get())
                .define('n', FORCE_FIELD_GENERATOR_PLATE.get())
                .define('e', Tags.Items.STORAGE_BLOCKS_EMERALD)
    ...
    public String getName() {
        return "Force-field Generator: Recipes";
    }
}
